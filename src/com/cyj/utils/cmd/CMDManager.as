package com.cyj.utils.cmd
{
	...
	public class CMDManager
	{
		...
		public static function start(filePath:String, workingPath:String=null):void
		{
			parserData = new Vector.<CMDData>();
			nativeProcessStartupInfo.executable = new File(filePath);
			if(workingPath)
				nativeProcessStartupInfo.workingDirectory = new File(workingPath);
		...
		public static function startCmd(workingPath:String=null):void
		{
			start("C:/Windows/System32/cmd.exe", workingPath);
		}

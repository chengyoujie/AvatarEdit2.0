	...
	public class LeftViewUI extends View {
		...
		protected static var uiView:XML =
			<View width="210" height="710">
			  ...
			  <Label text="Movie显示列表" x="21" y="494" width="99" height="18" color="0xffff99" align="center"/>
			  <List x="2" y="518" vScrollBarSkin="png.comp.vscroll" width="199" height="188" spaceY="2" var="listMovie">
			    <MovieItem x="0" y="0" name="render" runtime="com.cyj.app.view.view.MovieItem"/>
			  </List>
			  <Tree x="2" y="74" width="199" height="410" scrollBarSkin="png.comp.vscroll" spaceBottom="0" var="treeOut">
			  ...
			  <Button label="显" skin="png.guidecomp.btn_小按钮_1" x="132" y="493" width="24" height="23" var="btnMovieShow" labelColors="0xc79a84,0xe0a98d,0x93827a"/>
			  <Button label="清除" skin="png.guidecomp.btn_小按钮_1" x="158" y="493" width="39" height="23" var="btnMovieClear" labelColors="0xc79a84,0xe0a98d,0x93827a"/>
